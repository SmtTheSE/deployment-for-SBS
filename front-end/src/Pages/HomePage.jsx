            ...
            <>
              {currentNews.map((el, idx) => (
                <div
                  ...
                  } flex flex-col md:flex items-start p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 mb-6 gap-6 border border-gray-100 transform hover:-translate-y-1`}
                >
                  {/* Image */}
                  <div className="w-full md:w-64 h-48 md:h-40 flex-shrink-0 overflow-hidden rounded-xl">
                    <img
                      src={el.image}
                      alt={el.title}
                      loading="lazy"
            ...
            <>
              <div className="flex justify-center md:justify-between gap-6 flex-wrap">
                {currentAnnouncements.map((announcement) => (
                  <div
                    key={announcement.id}
                    className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-5 w-full sm:w-80 flex-shrink-0 border border-gray-100 hover:border-gray-200 transform transition-transform duration-300 hover:-translate-y-1"
                  >
                    {/* Image */}

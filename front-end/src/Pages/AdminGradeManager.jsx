...
const AdminGradeManager = () => {
  ...
  const fetchGrades = async () => {
    try {
      ...
      console.log("Response data:", response.data); // Debug info
      ...
      setGrades([]); // Ensure empty array even on error
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditing) {
        // Update grade level
        await axios.put(
          `/academic/grades/${currentGrade.gradeName}`,
          gradeEntity
        );
      } else {
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <FormButton variant="primary" onClick={openAddModal}>
            Add New Grade
          </FormButton>
        </div>
